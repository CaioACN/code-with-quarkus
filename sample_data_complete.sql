-- =====================================================
-- DADOS COMPLETOS PARA O SISTEMA DE PONTOS
...
INSERT INTO loyalty.notificacao (usuario_id, cartao_id, transacao_id, canal, tipo, status, titulo, mensagem, destino, criado_em, enviado_em) VALUES
    (1, 1, 1, 'EMAIL', 'ACUMULO', 'ENVIADA', 'Pontos Acumulados!', 'Você acumulou 4 pontos na sua compra de R$ 150,75.', 'joao.silva@email.com', '2024-12-01 12:30:00', '2024-12-01 12:31:00'),
    (2, 2, 5, 'EMAIL', 'ACUMULO', 'ENVIADA', 'Pontos Acumulados!', 'Você acumulou 8 pontos na sua compra de R$ 320,50.', 'maria.santos@email.com', '2024-12-01 19:20:00', '2024-12-01 19:21:00'),
    (4, 4, 12, 'EMAIL', 'ACUMULO', 'ENVIADA', 'Pontos Acumulados!', 'Você acumulou 11 pontos na sua compra de R$ 450,00.', 'ana.costa@email.com', '2024-12-01 20:00:00', '2024-12-01 20:01:00'),
    ...
    (4, 4, NULL, 'EMAIL', 'RESGATE', 'ENVIADA', 'Resgate Aprovado!', 'Seu resgate de R$ 25,00 foi aprovado e está sendo processado.', 'ana.costa@email.com', '2024-11-20 14:15:00', '2024-11-20 14:16:00'),
    (8, 8, 26, 'EMAIL', 'ACUMULO', 'ENVIADA', 'Pontos Acumulados!', 'Você acumulou 10 pontos na sua compra de R$ 380,75.', 'fernanda.lima@email.com', '2024-12-01 19:45:00', '2024-12-01 19:46:00'),
    (1, 1, NULL, 'EMAIL', 'RESGATE', 'ENVIADA', 'Resgate Concluído!', 'Seu resgate de R$ 10,00 foi concluído com sucesso.', 'joao.silva@email.com', '2024-11-25 16:00:00', '2024-11-25 16:01:00')
ON CONFLICT DO NOTHING;
